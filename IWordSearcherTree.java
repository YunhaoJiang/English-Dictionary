...
public interface IWordSearcherTree<ObjectType extends Comparable<ObjectType>> extends SortedCollectionInterface<ObjectType> {
     ...
     * @return
     */
    public boolean updateDefinition(ObjectType Word, String Definition);
    /**
     ...
     * @return
     */
    public IWord suggestWord(ObjectType Word);

    List<ObjectType> searchByStart(ObjectType searchWord);
}
